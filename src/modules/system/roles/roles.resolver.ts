...
export class RolesResolver {
  ...
  @Mutation(returns => RolesTypes)
  async assignSystemMenusToRole(
    @Args('assignSystemMenusToRoleInput')
    assignSystemMenusToRoleInput: AssignSystemMenusToRoleInput): Promise<RolesTypes> {
    return await this.rolesService.assignSystemMenusToRole(assignSystemMenusToRoleInput);
  }
